    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else
        {
            ...
            try{
                ...
                while(rs.next())
                {
                    String sql_username = rs.getString(2);
                    
                    if(sql_username.equals(username))
                    {
                       check = true; 
                       Edit_Employee obj = new Edit_Employee(rs.getString(1), rs.getString(2),rs.getString(3),rs.getString(4).charAt(0),rs.getString(5).charAt(0),rs.getString(6).charAt(0));
                       obj.setVisible(true);
                       this.dispose();
                    }
